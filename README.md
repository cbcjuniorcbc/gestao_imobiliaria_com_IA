...
👉 Siga o tutorial completo: TUTORIAL_ELECTRON.md
...
🗄️ Banco de Dados
Schema SQLite
Veja o schema completo em: database/schema.sql
...
Seed Data
Dados de exemplo para testes: database/seed.sql
...
Configuração
Instale o Google Drive for Desktop
No app, escolha uma pasta dentro do Drive como pasta raiz
O sistema criará automaticamente o database.db lá
⚠️ ATENÇÃO
...
Mais soluções: TUTORIAL_ELECTRON.md

📚 Documentação
Tutorial Electron completo
Schema do banco
Seed data
Tipos TypeScript
🤝 Contribuindo
...
Modifique as cores em src/index.css
Adicione novos componentes em src/components/
Estenda o schema em database/schema.sql
Adicione handlers IPC em electron/main.js
📄 Licença
...
Electron: Ver TUTORIAL_ELECTRON.md
